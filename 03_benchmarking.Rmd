...
rocplot <- ggplot(proteome_rocs) + 
  ...
  theme(legend.position = "bottom",
        ...
        strip.text = element_text(face = "italic",
                                  size = 10)) +
 scale_colour_manual(breaks = c("ampir_precursor", "ampir_precursor_nobench", "ampir_mature", "AMPscanner_v2", "amPEP", "AmpGram", "amPEPpy"),
...
ggsave(plot = rocandprplot, filename = "figures/proteomesrocandpr.png", width = 23, height = 18, units = "cm")
```
...
#  scale_fill_manual(values=c("#E69F00", "#56B4E9", "#D55E00",  "#CC79A7")) +
  ...
  theme(legend.position = "bottom",
   ...
   scale_color_manual(values=c("#CC79A7", "#56B4E9", "#D55E00", "#F0E442", "springgreen4", "hotpink", "lightgrey")) 
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("figures/TPFPcountproteomesXLIM.png", width = 19, height = 9 ,units = "cm")
```
...
```{r, eval=FALSE, echo=FALSE}
ggsave("figures/TPFPcountproteomes.png", width = 19, height = 9 ,units = "cm")
```
