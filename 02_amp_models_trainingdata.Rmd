...
AmPEP was redesigned in 2020 as Deep-AmPEP30 to focus on short AMPs ( < 30 amino acids) [Yan et al](https://doi.org/10.1016/j.omtn.2020.05.006) and its training and test data is available [here](https://cbbio.online/AxPEP/?action=dataset).
...
```{r}
iAMP2L <- read_faa("data/amp_predictors/iamp2l_bench.fasta") %>% 
