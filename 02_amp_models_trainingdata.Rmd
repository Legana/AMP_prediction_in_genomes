...
**Figure 2.1:** A) Sequence length,  B) Scatterplot of the first two principal components (PC), C) Density plot of the first PC of all AMP and non-AMP sequences used in various AMP prediction models and in the proteomes of *Homo sapiens* and *Arabidopsis thaliana*.
