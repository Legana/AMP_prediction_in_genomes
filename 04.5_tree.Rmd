...
p3 <- facet_plot(p2, panel = "AMP count", data = data.frame(swissprot_amps_count2), geom = geom_text, mapping = aes(x = AMP_count_rev2 + 60, label = AMP_count_rev2), size = 3)
...
p3 / ca3 + plot_annotation(tag_levels = "A")

```


```{r, echo = FALSE}
ggsave("figures/combined_tree.png", width = 24, height = 18, units = "cm")
```
