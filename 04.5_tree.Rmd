...
*for this figure I was thinking to colour the branch tip of Chordata and Arthropoda with two different colours in part A and then use those same colours to colour the Chordata and Arthropoda branches in part B (to make clearer that Part B is a "zoomed in" version of Part A.... I tried to do this today (using groupOTU, groupClade and using a column from the df but all without success ..... )*


## Combining the two trees and metadata

To see if tree looks better combined as 1 big tree rather than subdivided....
...
not sure if this is better as there are AMP counts for both the phylum "Chordata" and for the classes within Chordata (and same for Arthropoda) and they overlap on the AMP count panel plot which therefore looks messy ...
