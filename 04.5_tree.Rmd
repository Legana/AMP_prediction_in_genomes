...
caplot <- ggtree(newcatree, aes(colour = group)) +
  scale_colour_manual(values = c("#E7298A", "#A6761D")) + 
  geom_tiplab(offset = 0.9, size=4, color ="Black") +
...
*TODO: either hide the "group" legend or edit it and rename the 0 and 1 to Chordata and Arthropoda respectively. How?...* 
